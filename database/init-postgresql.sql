-- =============================================
-- Goma Security - PostgreSQL Database Script
...
DROP TRIGGER IF EXISTS update_alert_resolved_at ON alerts;
...
INSERT INTO emergency_types (nom, icone, couleur, priorite, description) VALUES
...
INSERT INTO zones (nom, description, latitude, longitude, rayon) VALUES
...
-- Insérer un centre de sécurité de test
INSERT INTO users (nom, prenom, telephone, email, password_hash, role, quartier, is_active) VALUES
    ('Centre', 'Sécurité Goma', '+243333333333', 'centre@gomasecurity.cd', 
     '$2a$10$rQZ8kHp0rVX1JcXxQz1ZxOQZ8kHp0rVX1JcXxQz1ZxOQZ8kHp0rVX', 
